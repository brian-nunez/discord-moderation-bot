...
var _default = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(config, client, message, args) {
    var response, member, add, roleAdd;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 24:
            roleAdd = message.guild.roles.cache.find(function (role) {
              return role.name === add;
            });
          ...
          case 32:
            ...
            _context.next = 35;
            return message.channel.send("This user already has the ".concat(add, " role"));
          ...
          case 39:
            _context.next = 41;
            return member.roles.add(roleAdd.id);

          case 41:
            _context.next = 43;
            return message.channel.send("".concat(add, " added to ").concat(member.displayName));
