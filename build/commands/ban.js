    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 27:
            _context.next = 29;
            return message.channel.send("".concat(member.user.tag, " was banned, no reason was provided"));
          ...
          case 32:
            _context.next = 34;
            return message.channel.send("".concat(member.user.tag, " was banned for ").concat(reason));
